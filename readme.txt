...
Hides the content editor for the page currently selected as the "posts page". 
...
Please see [this page on the codex](http://codex.wordpress.org/Creating_a_Static_Front_Page#Creating_a_Static_Front_Page) for more info.
